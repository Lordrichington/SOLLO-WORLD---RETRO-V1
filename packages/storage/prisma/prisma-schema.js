...
type AggregateHabboBadges {
  count: Int!
}

type AggregateHabboItems {
  count: Int!
}
...
type HabboBadgesConnection {
  pageInfo: PageInfo!
  edges: [HabboBadgesEdge]!
  aggregate: AggregateHabboBadges!
}

input HabboBadgesCreateInput {
  id: ID
  habbo: HabboCreateOneInput!
  badge: String!
}

type HabboBadgesEdge {
  node: HabboBadges!
  cursor: String!
}

enum HabboBadgesOrderByInput {
  id_ASC
  id_DESC
  badge_ASC
  badge_DESC
...
type HabboBadgesPreviousValues {
  id: ID!
  badge: String!
}

type HabboBadgesSubscriptionPayload {
  mutation: MutationType!
  node: HabboBadges
  updatedFields: [String!]
...
input HabboBadgesSubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: HabboBadgesWhereInput
  AND: [HabboBadgesSubscriptionWhereInput!]
  OR: [HabboBadgesSubscriptionWhereInput!]
  NOT: [HabboBadgesSubscriptionWhereInput!]
}

input HabboBadgesUpdateInput {
  habbo: HabboUpdateOneRequiredInput
  badge: String
}

input HabboBadgesUpdateManyMutationInput {
  badge: String
}

input HabboBadgesWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  AND: [HabboBadgesWhereInput!]
  OR: [HabboBadgesWhereInput!]
  NOT: [HabboBadgesWhereInput!]
}

input HabboBadgesWhereUniqueInput {
  id: ID
}
...
type HabboItemsConnection {
  pageInfo: PageInfo!
  edges: [HabboItemsEdge]!
  aggregate: AggregateHabboItems!
}

input HabboItemsCreateInput {
  id: ID
  habbo: HabboCreateOneInput!
  item: String
}
...
type HabboItemsPreviousValues {
  id: ID!
  item: String
}

type HabboItemsSubscriptionPayload {
  mutation: MutationType!
  node: HabboItems
  updatedFields: [String!]
...
input HabboItemsSubscriptionWhereInput {
  mutation_in: [MutationType!]
  updatedFields_contains: String
  updatedFields_contains_every: [String!]
  updatedFields_contains_some: [String!]
  node: HabboItemsWhereInput
  AND: [HabboItemsSubscriptionWhereInput!]
  OR: [HabboItemsSubscriptionWhereInput!]
  NOT: [HabboItemsSubscriptionWhereInput!]
}

input HabboItemsUpdateInput {
  habbo: HabboUpdateOneRequiredInput
  item: String
}

input HabboItemsUpdateManyMutationInput {
  item: String
}

input HabboItemsWhereInput {
  id: ID
  id_not: ID
  id_in: [ID!]
  id_not_in: [ID!]
  ...
  AND: [HabboItemsWhereInput!]
  OR: [HabboItemsWhereInput!]
  NOT: [HabboItemsWhereInput!]
}

input HabboItemsWhereUniqueInput {
  id: ID
}
...
type Mutation {
  ...
  updateManyHabboBadgeses(data: HabboBadgesUpdateManyMutationInput!, where: HabboBadgesWhereInput): BatchPayload!
  upsertHabboBadges(where: HabboBadgesWhereUniqueInput!, create: HabboBadgesCreateInput!, update: HabboBadgesUpdateInput!): HabboBadges!
  deleteHabboBadges(where: HabboBadgesWhereUniqueInput!): HabboBadges
  deleteManyHabboBadgeses(where: HabboBadgesWhereInput): BatchPayload!
  createHabboItems(data: HabboItemsCreateInput!): HabboItems!
  updateHabboItems(data: HabboItemsUpdateInput!, where: HabboItemsWhereUniqueInput!): HabboItems
  updateManyHabboItemses(data: HabboItemsUpdateManyMutationInput!, where: HabboItemsWhereInput): BatchPayload!
  upsertHabboItems(where: HabboItemsWhereUniqueInput!, create: HabboItemsCreateInput!, update: HabboItemsUpdateInput!): HabboItems!
  deleteHabboItems(where: HabboItemsWhereUniqueInput!): HabboItems
  deleteManyHabboItemses(where: HabboItemsWhereInput): BatchPayload!
...
type Query {
  ...
  habboBadgesesConnection(where: HabboBadgesWhereInput, orderBy: HabboBadgesOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): HabboBadgesConnection!
  habboItems(where: HabboItemsWhereUniqueInput!): HabboItems
  habboItemses(where: HabboItemsWhereInput, orderBy: HabboItemsOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): [HabboItems]!
  habboItemsesConnection(where: HabboItemsWhereInput, orderBy: HabboItemsOrderByInput, skip: Int, after: String, before: String, first: Int, last: Int): HabboItemsConnection!
...
type Subscription {
  ...
  habboBadges(where: HabboBadgesSubscriptionWhereInput): HabboBadgesSubscriptionPayload
  habboItems(where: HabboItemsSubscriptionWhereInput): HabboItemsSubscriptionPayload
